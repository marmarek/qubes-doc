...
- Qubes Core Agent: qrexec agent and services. Needed for proper
  ...
  - Move user profiles: user profile directory (c::raw-latex:`\users`)
    ...
    SYSTEM MESSAGE  for: /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:469: (INFO/1) No role entry for "raw-latex" in module "docutils.parsers.rst.languages.en".
    Trying "raw-latex" as canonical role name.
    No role entry for "raw-latex" in module "docutils.parsers.rst.languages.en".
    Trying "raw-latex" as canonical role name.
    SYSTEM MESSAGE  for: /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:469: (ERROR/3) Unknown interpreted text role "raw-latex".
...
.. list-table:: 
   ...
   * - /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:569: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Component**
     - /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:569: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Setting**
     - /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:569: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Type**
     - /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:569: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Description**
     - Default value
   * - qga
     - Disa bleCursor
     - DWORD
...
SYSTEM MESSAGE  for: /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:615: (INFO/1) No role entry for "raw-latex" in module "docutils.parsers.rst.languages.en".
Trying "raw-latex" as canonical role name.
No role entry for "raw-latex" in module "docutils.parsers.rst.languages.en".
Trying "raw-latex" as canonical role name.
SYSTEM MESSAGE  for: /home/user/qubes-doc-rst/user/templates/windows/qubes-windows-tools-4-0.rst:615: (ERROR/3) Unknown interpreted text role "raw-latex".
Unknown interpreted text role "raw-latex".
