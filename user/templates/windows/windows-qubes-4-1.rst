...
- Using Qube Manager
  ...
  SYSTEM MESSAGE  for: /home/user/qubes-doc-rst/user/templates/windows/windows-qubes-4-1.rst:105: (ERROR/3) Unexpected indentation.
...
- Install Windows on the new VM
  ...
  - **For Windows 11 only**: Windows 11 requires TPM 2.0, which
    ...
    SYSTEM MESSAGE  for: /home/user/qubes-doc-rst/user/templates/windows/windows-qubes-4-1.rst:249: (WARNING/2) Field list ends without a blank line; unexpected unindent.
...
`Customizing Windows 7 templates <https://github.com/Qubes-Community/Contents/blob/master/docs/customization/windows-template-customization.md>`__ page (despite the
