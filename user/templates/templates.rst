...
- ``qvm-trim-template`` is no longer necessary or available in Qubes
  ...
  handled automatically. No user action is required. See :doc:`Disk Trim <https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md>` for more information.
