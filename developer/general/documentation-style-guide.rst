...
and blogs), but there is an especially large collection in the `Qubes Community <https://github.com/Qubes-Community>`__ project. External
...
to submit it to the `Qubes Community <https://github.com/Qubes-Community>`__ project instead.
However, *linking* to external documentation from
`qubes-doc <https://github.com/QubesOS/qubes-doc>`__ is perfectly fine.
Indeed, the maintainers of the `Qubes Community <https://github.com/Qubes-Community>`__ project should
...
to add and update Qubes Community links in the :ref:`“External documentation” <external documentation>` section of the
